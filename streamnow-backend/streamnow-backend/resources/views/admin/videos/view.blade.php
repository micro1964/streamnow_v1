                ...
                <div class="panel-body">
                    ...
                    <div class="post">
                        <div class="user-block">
                            ...
                            <span class="username">
                                <a href="{{$data->user ? route('admin.users.view' , $data->user->id ): '#' }}">{{$data->user ? $data->user->name : tr('user_not_available')}}</a>
                                          ...
                                          <div class="main_video_error live_img" id="main_video_setup_error" style="display: none;">
                                            ...
                                            <div class="flash_display" id="flash_error_display" style="display: none;">
                                                <div class="flash_error_div">
                                                    <div class="flash_error">{{tr('flash_missing_error')}}<a target="_blank" href="http://get.adobe.com/flashplayer/" class="underline"> Adobe</a>.</div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="header">
                                            <h4><b>{{tr('browser_name')}}</b></h4>
                                                <b>{{$data->browser_name ? $data->browser_name : "-"}}</b>
                                    </div>
                                    <div class="header">
                            ...
                            <div class="col-sm-3">
                                <div class="header">
                                    <h4><b>{{tr('viewers_count')}}</b></h4>
                                        <b>{{$data->viewer_count ? $data->viewer_count : "0"}}</b>

                                </div>
                                <div class="header">
                                    <h4><b>{{tr('start_time')}}</b></h4>
                                        <b>{{$data->start_time ? $data->start_time : "-"}}</b>

                                </div>
                                <div class="header">
                                    <h4><b>{{tr('end_time')}}</b></h4>
                                    <b>{{$data->end_time ? $data->end_time : "-"}}</b>
                                </div>
                                <div class="header">
