            ...
            <form action="{{route('admin.custom.live.save')}}" method="POST" enctype="multipart/form-data" role="form">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" required name="rtmp_video_url" class="form-control" id="rtmp_video_url" placeholder="{{tr('rtmp_video_url')}}" value="{{old('rtmp_video_url') ?: $model->rtmp_video_url}}">
                    </div>
