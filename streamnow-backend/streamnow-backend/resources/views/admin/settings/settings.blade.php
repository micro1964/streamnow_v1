                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="MAIL_DRIVER" id="MAIL_DRIVER" placeholder="{{tr('MAIL_DRIVER')}}" value="{{old('MAIL_DRIVER') ?: $result['MAIL_DRIVER']}}">
                                </div>
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <h3 class="settings-sub-header text-uppercase"><b>{{tr('commission_spilit')}}</b></h3>
