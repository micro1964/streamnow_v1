...
@section('title', tr('add_photo'))

@section('content-header', tr('add_photo'))
...
@section('breadcrumb')
    ...
    <li><a href="{{route('admin.streamer_galleries.list', $user->id)}}"><i class="fa fa-user"></i> {{tr('galleries')}}</a></li>
    <li class="active">{{tr('add_photo')}}</li>
@endsection
        ...
        <div class="col-md-10 ">
            ...
            <div class="box box-primary">
                ...
                <div class="box-header label-primary">
                    <b>{{tr('add_photo')}}</b>
                    <a href="{{route('admin.streamer_galleries.list', $user->id)}}" style="float:right" class="btn btn-default">{{tr('galleries')}}</a>
                </div>
                    ...
                    <div class="box-body">
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                ...
                                <textarea class="form-control" name="gallery_description">{{ $user->gallery_description}}</textarea>
