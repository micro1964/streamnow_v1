...
@section('title', tr('upload_video'))

@section('content-header', tr('upload_video'))

@section('breadcrumb')
    <li><a href=""><i class="fa fa-dashboard"></i>{{tr('home')}}</a></li>
    <li><a href=""><i class="fa fa-key"></i> {{tr('videos')}}</a></li>
    <li class="active">{{tr('upload_video')}}</li>
@endsection
        ...
        <div class="col-md-10">
            ...
            <div class="box box-primary">
                ...
                <div class="box-header label-primary">
                    <b style="font-size: 18px;">{{tr('upload_video')}}</b>
                    <a href="{{route('admin.vod-videos.index')}}" style="float:right" class="btn btn-default">{{tr('videos')}}</a>
                </div>
                ...
                <form class="form-horizontal" action="{{route('admin.vod-videos.save')}}" method="POST" enctype="multipart/form-data" role="form" >
                    ...
                    <!--  <div class="section_loader">
                        <img src="{{asset('images/section_loader.svg')}}"/>
                    </div> -->
                </form>
