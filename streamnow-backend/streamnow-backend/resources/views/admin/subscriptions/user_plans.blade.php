									...
									@foreach($payments as $i => $payment)
									    ...
									    <tr>
									      	...
									      	<td>
									      		...
									      		<a href="{{route('admin.subscriptions.view' , $payment->subscription->unique_id)}}">{{$payment->subscription ? $payment->subscription->title : tr('subscription_not_available')}}</a>
									      		@endif
									      	</td>
									...
									<div class="thumbnail">
										...
										<div class="caption">
											...
											<p>
												...
												<a onclick="return confirm(&quot;{{$subscription->title}} - {{tr('you_want_choose_plan')}}&quot;);" href="{{route('admin.subscription.save' , ['s_id' => $subscription->id, 'u_is'=>$id])}}" class="btn btn-success pull-right">{{tr('choose')}}</a>
