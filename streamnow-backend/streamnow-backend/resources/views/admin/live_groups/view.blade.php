...
@section('breadcrumb')
    ...
    <li class="active"><i class="fa fa-key"></i> {{tr('live_groups_view')}}</li>
@endsection
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        ...
                        @if(count($members) == 0)
                            ...
                            <div class="col-md-12"><p>No members yet</p></div>
                                    ...
                                    <ul class="products-list product-list-in-box">
                                        ...
                                        <li class="item">
                                            ...
                                            <div class="product-info">
                                                <a href="{{route('admin.users.view' , $member_details->member_id)}}" class="product-title">{{$member_details->member_name}}
                                                </a>
