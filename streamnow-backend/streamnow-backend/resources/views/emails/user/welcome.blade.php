...
<div class="btn-cls">
<a href="{{url('/')}}/email/verification?id={{$email_data->id}}&verification_code={{$email_data->verification_code}}" style="color:#fff;background-color:#cf000f;border:0; padding:10px 25px;border-radius:20px;font-size:16px;text-decoration:none;">{{tr('verify_now')}}</a>
</div>
@endif
