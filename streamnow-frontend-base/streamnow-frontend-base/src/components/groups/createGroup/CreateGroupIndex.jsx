    ...
    return (
      <div className="main">
        ...
        <div className="sec-padding create-group left-spacing1">
          <div className="row">
            <h3 className="public-video-header">Create Groups</h3>
            ...
            <div className="row small-padding">
              <div className="col-sm-12 col-md-12 col-lg-12">
                <form className="create-group-file" onSubmit={this.saveGroup}>
                  ...
                  <div className="">
                    {/* <h2 className="group-heading">Create Groups</h2>*/}
                    ...
                    <div className="text-right resp-center">
                      ...
                      >
                        {loadingContent != null ? loadingContent : "Create"}
                      </button>
                    </div>
                  </div>
                </form>
...
export default withToastManager(CreateGroupIndex);
