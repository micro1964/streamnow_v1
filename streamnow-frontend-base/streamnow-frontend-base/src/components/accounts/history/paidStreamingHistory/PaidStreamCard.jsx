      ...
      <div className="col-xs-12 col-sm-6 col-md-4 col-lg-4 top-margin">
        <div className="live-video-box relative">
          ...
          >
            ...
            <h4 className="detail-head mt-0">Video payment details</h4>
            <div className="timeline">
              <div className="timeline-item">
                ...
                <div className="history-content">
                  <ul>
                    <li>
                      <p className="text-grey-clr">transaction id</p>
                      <h4>
              ...
              <div className="timeline-item">
                ...
                <div className="history-content">
                  <ul>
                    <li>
                      <p className="text-grey-clr">amount</p>
                      <h4>
              ...
              <div className="timeline-item">
                ...
                <div className="history-content">
                  <ul>
                    <li>
                      <p className="text-grey-clr">paid amount</p>
                      <h4>
                        <span className="black-clr">
                          {video.live_video_amount_formatted}
                        </span>
