...
class RedeemIndex extends Component {
  ...
  cancelRedeem = (event, payment) => {
    ...
    this.setState({
      ...
      cancelLoadingContent: "Cancelling...",
    });
    setTimeout(() => {
      api
    ...
    return (
      <div className="main">
        ...
        <div className="sec-padding redeems-promo left-spacing1">
          <div className="row">
            <h3 className="heading-element text-center">Redeems</h3>
              ...
              <div className="row">
                <div className="col-lg-5">
                  <div className="redeems-sec redeems">
                    ...
                    <h3 className="mt-0">Redeems</h3>
                    <h4 className="redeem-text">
                      Hey, Do you want to redeem your balance? If so, please
                      click “send Redeem” button. Admin will process your
                      payment ASAP.
                    </h4>
...
export default withToastManager(RedeemIndex);
