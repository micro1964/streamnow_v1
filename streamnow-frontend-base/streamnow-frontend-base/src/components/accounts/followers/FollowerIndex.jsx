...
class FollowerIndex extends Component {
  ...
  unFollowUser = (event, user) => {
    ...
    this.setState({
      ...
      unfollowbuttonLoadingContent: "Loading...",
    });
    api
    ...
    return (
      <div className="main">
        ...
        <div class="sec-padding followers left-spacing1">
          <div class="public-video-header top-margin">FOLLOWERS</div>
          {loadingFollower ? (
            "Loading..."
            ...
            <>
              ...
              <div className="row">
                <div className="col-md-12 text-center">
                  ...
                  >
                    {loadingContent != null ? loadingContent : "Load More"}
                  </button>
                </div>
              </div>
            </>
...
export default withToastManager(FollowerIndex);
